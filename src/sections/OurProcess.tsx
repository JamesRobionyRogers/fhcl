...
export default function OurProcess({props}) {
    ...
    return (
        <div id="our-process" className="bg-white mx-auto max-w-7xl px-6 lg:px-8 ">
            ...
            <ol className="relative border-s border-gray-200">
                ...
                <li className="mb-10 ms-6">
                    ...
                    <div className="pl-3">
                        <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900">Contact Us</h3>
                ...
                <li className="mb-10 ms-6">
                    ...
                    <div className="pl-3">
                        <h3 className="mb-1 text-lg font-semibold text-gray-900">Arrange a Quote</h3>
                ...
                <li className="ms-6">
                    ...
                    <div className="pl-3">
                        <h3 className="mb-1 text-lg font-semibold text-gray-900">Get to Work</h3>
                        <p className="text-base font-normal text-gray-500">
