...
export default function Example() {
    ...
    const ContactImagePath = "./src/assets/projectsImages/IMG121400.jpg"
    ...
    return (
        <div id="contact-us" className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div className="mx-auto mt-16 max-w-7xl grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2 sm:mt-20">
                <form action="#" method="" className="max-w-xl">
